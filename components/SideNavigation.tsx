...
function SideNav() {
  ...
  return (
    <div className="sideNav min-h-[50vh] fixed max-lg:hidden flex justify-center items-center top-[26%] opacity-70 shadow-2xl right-[5px] rounded-full bg-gray-400  z-[9999]">
